...
public class HDTProcessorTest extends Assert{
	
	private IOProcessor processor = null;
	
	private String datasetPLD = "http://example.org";
	private String datasetLocation = this.getClass().getClassLoader().getResource("processor-datadumps/test-data-40377.hdt").toExternalForm().replace("file:", "");
	...
	public void setUp() throws Exception {
		...
		processor = new HDTProcessor(datasetPLD, datasetLocation, generateReport, metricConf);
	}
