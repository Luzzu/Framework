...
public class CacheManager{
	...
	public void createNewCache(String cacheName, int maxItems) {
		createNewCache(cacheName, maxItems, false);
	}
	 ...
	 * @param cacheName - Name given to the required cache
	 * @param maxItems - Max number of items stored in the cache
	 * @param forceHeapCache - Forcing luzzu to save the newly created cache in heap
	 */
	public void createNewCache(String cacheName, int maxItems, boolean forceHeapCache) {
		registeredCache.put(cacheName, new Cache(cacheName, maxItems, forceHeapCache));
	}
